...
public interface IUserDao {
    ...
    @Results({
            ...
            @Result(property = "roles",column = "id",javaType = java.util.List.class,many = @Many(select="com.fy.ssm.dao.IRoleDao.findRoleByUserId"))
    })
    ...
    @Results({
            ...
            @Result(property = "phoneNum",column = "phoneNum"),
            @Result(property = "status",column = "status"),
            @Result(property = "roles",column = "id",javaType = List.class,many = @Many(select = "com.fy.ssm.dao.IRoleDao.findRoleByUserId"))
