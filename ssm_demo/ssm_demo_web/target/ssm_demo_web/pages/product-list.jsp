...
<%--								<div class="has-feedback">
									<input type="text" class="form-control input-sm" placeholder="搜索" id="search_input">
									<span class="glyphicon glyphicon-search form-control-feedback" id="search-button"></span>
								</div>--%>
								<div class="search">
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.pageSize}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
	...
	<script>
		$("#search-button").click(function () {
        	...
        	location.href = "${pageContext.request.contextPath}/product/findByName.do?pname="+pname;
		})
